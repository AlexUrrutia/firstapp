...
void main() {
  ...
  const methodChannel = MethodChannel('mesibo_call_channel');
  Future<void> invokeMesiboCall(
      MesiboProfile profile, bool video, bool waiting) async {
    try {
      final result = await methodChannel.invokeMethod(
        'MesiboCall_OnIncoming',
        {'profile': profile.toString(), 'video': video, 'waiting': waiting},
      );
 ...
 **************************************************************************************************/
  DemoUser user1 = DemoUser(
      "49040d10b63e7ebd2cb2f29bbb1053b41142f4b9e2a63982a50de3349fb84vada9538be97",
      'user2');
  DemoUser user2 = DemoUser(
      "a8ff38eacfc0b74fb450310c860c16b09cc98bcac9b89e6649fb85ga89be2d8c26",
      'user1');
